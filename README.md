...
```python
from shogi_vision import image_to_sfen, render_board, render_sfen_pretty
...
# SFEN → きれいな盤画像（デモ/検証用）
pretty = render_sfen_pretty("lnsgkgsnl/1r5b1/ppppppppp/9/9/9/PPPPPPPPP/1B5R1/LNSGKGSNL b - 1")
```
